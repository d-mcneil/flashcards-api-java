...
--DROP SEQUENCE IF EXISTS seq_user_id, seq_deck_id, seq_card_id, seq_settings_id; // TODO: delete commented out code once I know identity is working

--CREATE SEQUENCE seq_user_id // TODO: delete commented out code once I know identity is working
--    INCREMENT BY 1
--    START WITH 1001
--    NO MAXVALUE;
...
CREATE TABLE users (
--	user_id INTEGER NOT NULL DEFAULT nextval('seq_user_id'), // TODO: delete commented out code once I know identity is working
    user_id INTEGER GENERATED BY DEFAULT AS IDENTITY (START WITH 1001), -- for testing
--  user_id INTEGER GENERATED ALWAYS AS IDENTITY (START WITH 1001), -- for production // TODO: switch commented out code for production
...
CREATE TABLE deck (
--	deck_id BIGINT NOT NULL DEFAULT nextval('seq_deck_id'), // TODO: delete commented out code once I know identity is working
	deck_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 2001), -- for testing
--	deck_id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 2001), -- for production // TODO: switch commented out code for production
...
CREATE TABLE card (
--	card_id BIGINT NOT NULL DEFAULT nextval('seq_card_id'), // TODO: delete commented out code once I know identity is working
	card_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 3001), -- for testing
--	card_id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 3001), -- for production // TODO: switch commented out code for production
...
--  settings_id BIGINT NOT NULL DEFAULT nextval('seq_settings_id'), // TODO: delete commented out code once I know identity is working
    settings_id BIGINT GENERATED BY DEFAULT AS IDENTITY (START WITH 4001), -- for testing
--  settings_id BIGINT GENERATED ALWAYS AS IDENTITY (START WITH 4001), -- for production // TODO: switch commented out code for production
